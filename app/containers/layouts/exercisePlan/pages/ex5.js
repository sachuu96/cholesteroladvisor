...
class FifthEx extends Component {
    ...
    componentDidMount() {
        ...
        const { ex2 } = this.props
        if (ex2 == "crunch with hand resting") {
            this.setState({
        ...
        return (
            <Card>
                ...
                <CardAction
                    ...
                    />
                    <CardButton
                        onPress={() => { this.props.navigation.navigate('SixExcScreen') }}
                        title="Skip"
                        color="blue"
                    />
                    <CardButton
